...
public Room(boolean canGoNorth, boolean canGoSouth, boolean canGoEast, boolean canGoWest, String name, String description, InventoryItem item){
 ...
 */
 public Room(boolean canGoNorth, boolean canGoSouth, boolean canGoEast, boolean canGoWest, String name, String description, ArrayList<InventoryItem> items){
    this(canGoNorth, canGoSouth, canGoEast, canGoWest, name, description);
...
public InventoryItem removeObject(String objName){
    ...
    while(iterator.hasNext()){
        ...
        if(item.getName().equalsIgnoreCase(objName)){
            iterator.remove();
            return item;
        }
    }
...
public String getNamesOfObjectsInRoom() {
    ...
    StringBuilder sb = new StringBuilder("Items in room are: ");
    for (InventoryItem item : inventory){
